function handleLogin(event) {
  ...
  if (email === "devansh@example.com" && password === "password123") {
    ...
    errorMessage.textContent = "Invalid credentials. Try devansh@example.com / password123"
...
function renderSongs() {
  ...
  songsGrid.innerHTML = popularSongs
    .map(
      (song, index) => `
    <li class="track-item ${currentTrack === index ? "active" : ""}" onclick="selectTrack(${index+1})">
    <div class="song-card">
